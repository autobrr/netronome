...
DROP INDEX IF EXISTS idx_bandwidth_samples_agent_time;
...
CREATE INDEX idx_bandwidth_samples_agent_time ON monitor_bandwidth_samples(agent_id, created_at DESC);
