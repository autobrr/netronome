...
ALTER TABLE packet_loss_results ADD COLUMN used_mtr BOOLEAN DEFAULT 0;
...
ALTER TABLE packet_loss_results ADD COLUMN privileged_mode BOOLEAN DEFAULT 0; -- Track if test ran in privileged (ICMP) mode
