    ...
    <div className="space-y-6">
      ...
      {hasAnyTests && latestTest && (
        <motion.div
          ...
          className="mb-6"
        >
          <h2 className="text-white text-xl ml-1 font-semibold">Latest Run</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-800">
                  ...
                  <th className="text-left py-3 px-2 text-gray-400 font-medium">Server</th>
                  ...
                  <th className="text-right py-3 px-2 text-gray-400 font-medium">Jitter</th>
                  <th className="text-right py-3 px-2 text-gray-400 font-medium">Download</th>
                  <th className="text-right py-3 px-2 text-gray-400 font-medium">Upload</th>
                </tr>
              </thead>
              <tbody>
                {displayedTests.map((test) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-2 text-gray-300 truncate max-w-[150px]" title={test.serverName}>
                      {test.serverName}
                    </td>
                    ...
                    <td className="py-3 px-2 text-right text-amber-400 font-mono">
                      {parseFloat(test.latency).toFixed(1)}ms
                    </td>
                    <td className="py-3 px-2 text-right text-purple-400 font-mono">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-amber-400 font-mono">{parseFloat(test.latency).toFixed(1)}ms</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-400 font-mono">{formatSpeed(test.downloadSpeed)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Upload:</span>
                    <span className="text-blue-400 font-mono">{formatSpeed(test.uploadSpeed)}</span>
                  </div>
                </div>
              </motion.div>
            ))}
              ...
              <div className="flex items-center justify-center gap-3">
                {tests.length > displayCount && (
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-blue-600/10 hover:bg-blue-600/20 text-blue-400 hover:text-blue-300 rounded-lg transition-colors duration-200 text-sm font-medium"
                  >
                ...
                {displayCount > 5 && (
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-gray-600/10 hover:bg-gray-600/20 text-gray-400 hover:text-gray-300 rounded-lg transition-colors duration-200 text-sm font-medium"
                  >
                    Show less
                    <span className="ml-2">↑</span>
                  </button>
